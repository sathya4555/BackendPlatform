...
export class App_MessagesRoutes{
    ...
    for (var i = 0; i < this.topicArray.length; i++) {
      this.sns_sqs.listenToService(this.topicArray[i], this.serviceName[i], (() => {
        ...
        return async (result) => {
          ...
          try {
            let responseModelOfApp_MessagesDto: ResponseModel<appDTO> = null;
            ...
            let requestModelOfApp_MessagesDto: RequestModel<appDTO> = result["message"];
            ...
            for (let index = 0; index < result.OnFailureTopicsToPush.length; index++) {
              ...
              let errorResult: ResponseModel<appDTO> = new ResponseModel<appDTO>(null,null,null,null,null,null,null,null,null);;
  ...
  @Post("") 
  async createApp_Messages(@Body() body:RequestModel<appDTO>): Promise<ResponseModel<appDTO>> {  //requiestmodel<STUDENTDto></STUDENTDto>....Promise<ResponseModel<Grou[pDto>>]
    try {
  ...
  @Put("/")
  async updateapp_messages(@Body() body: RequestModel<appDTO>): Promise<ResponseModel<appDTO>> {  //requiestmodel<STUDENTDto></STUDENTDto>....Promise<ResponseModel<Grou[pDto>>]
    try {
  ...
  @Delete('/')
  deleteApp_Messages(@Body() body:RequestModel<appDTO>): Promise<ResponseModel<appDTO>>{
    try {
